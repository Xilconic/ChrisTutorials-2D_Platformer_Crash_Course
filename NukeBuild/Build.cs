...
{
    private const string AppName = "ChrisTutorialsPlatformerCrashCourse";

    private static readonly AbsolutePath _unityGameSrcDirectory = RootDirectory / "ChrisTutorialsPlatformerCrashCourse";
